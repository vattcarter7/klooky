...
exports.up = (pgm) => {
  pgm.sql(`
    ...
    VALUES (1, 1, 'angkor tour', '["water", "car"]', '["lunch", "personal expense"]', '["8:00 start tour", "5:00 come back hotel"]', '["pickup at 7:45"]', '["37$ for ticket"]'),
           (1, 2, '앙코르 투어', '["물", "차"]', '["점심", "개인 경비"]', '["8:00 투어 시작", "5:00 호텔로 들어온다"]', '["7:45분에 픽업"]', '["입장료 37$"]');
  `);
};
